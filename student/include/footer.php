<style>
    ...
    <footer style="background-color: #26272b; position:relative; bottom:0;" class="p-3">
        ...
        <div class="container border-top border-secondary py-3 pb-0 justify-content-middle">
            <h6 class="text-muted">Developed By <a href="" class=>Vikas</a> & <a href="" class=>Alok</a> (student of CWS)</h6>
        </div>
    </footer>
